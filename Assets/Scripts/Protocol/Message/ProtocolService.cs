...
Dictionary<Type, ushort> messageInfoDic;
        public ProtocolService()
        {
            ...
            messageInfoDic.Add(typeof(BattleStateAndStageReqMsg), 2);
            messageInfoDic.Add(typeof(BattleStateAndStageResMsg), 3);
            messageInfoDic.Add(typeof(FrameBattleRoleSpawnReqMsg), 4);
            messageInfoDic.Add(typeof(FrameBattleRoleSpawnResMsg), 5);
            messageInfoDic.Add(typeof(FrameBulletHitRoleResMsg), 6);
            messageInfoDic.Add(typeof(FrameBulletHitFieldResMsg), 7);
            messageInfoDic.Add(typeof(FrameBulletLifeOverResMsg), 8);
            ...
            messageInfoDic.Add(typeof(FrameRollReqMsg), 13);
            ...
            messageInfoDic.Add(typeof(FrameWeaponReloadReqMsg), 19);
            messageInfoDic.Add(typeof(FrameWeaponReloadResMsg), 20);
