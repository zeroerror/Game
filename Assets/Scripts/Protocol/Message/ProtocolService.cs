...
Dictionary<Type, ushort> messageInfoDic;
        public ProtocolService()
        {
            ...
            messageInfoDic.Add(typeof(BattleEntityTearDownResMsg), 2);
            messageInfoDic.Add(typeof(BattleRoleSyncMsg), 3);
            messageInfoDic.Add(typeof(BattleStateAndStageReqMsg), 4);
            messageInfoDic.Add(typeof(BattleStateAndStageResMsg), 5);
            messageInfoDic.Add(typeof(FrameBattleRoleSpawnReqMsg), 6);
            messageInfoDic.Add(typeof(FrameBattleRoleSpawnResMsg), 7);
            messageInfoDic.Add(typeof(FrameBulletHitEntityResMsg), 8);
            messageInfoDic.Add(typeof(FrameBulletHitFieldResMsg), 9);
            messageInfoDic.Add(typeof(FrameBulletSpawnResMsg), 10);
